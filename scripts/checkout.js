  ...
  deliveryOptions.forEach((deliveryOption) => {
    ...
    `
      ...
      data-delivery-option-id="${deliveryOption.id}"> 
          ...
          <div> <div class="delivery-option-date"> ${dateString} </div>
            <div class="delivery-option-price"> ${priceString} Shipping </div> </div> 
        </div> 
    `
...
document.querySelectorAll('.js-update-link').forEach((link) => { 
  link.addEventListener('click', () => { 
    ...
    const displa = document.querySelector('.is-editing-quantity');
